...
namespace TitanicPredictor_MachineLearning
{
    ...
    {
        /// <summary>
        /// model input class for TitanicAuto_CabinLetterFilledin.
        /// </summary>
        ...
        public class ModelInput
        {
            ...
            public string CabinLetter { get; set; }
        ...
        /// <summary>
        /// model output class for TitanicAuto_CabinLetterFilledin.
        /// </summary>
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"CabinLetter")]
            public uint CabinLetter { get; set; }
        ...
        private static string MLNetModelPath = Path.GetFullPath("TitanicAuto-CabinLetterFilledin.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("CabinLetter");
            if (labelColumn == null)
            {
                throw new Exception("CabinLetter column not found. Make sure the name searched for matches the name in the schema.");
            }
